...
//INITIALISE
void fsm_init();								//initialise elevator
...
//int fsm_is_stop_button_pressed();			  			denne er i den oppgaven du sendte meg, det eneste den gjør er å sjekke om stoppknappen er trykket eller ikke
